const Reportable = function(data, options = {}) {
...
Reportable.prototype.sortRows = function(data, index = 0, order = 'asc') {
	if (data) {
...
Reportable.prototype.updateTable = function(data, options = {}) {
